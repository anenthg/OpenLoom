    ...
    <main className="overflow-x-hidden">
      ...
      <section className="relative bg-[var(--warp-indigo)] px-6 py-16">
        <div className="mx-auto max-w-2xl text-center" data-reveal>
          <div className="inline-flex items-center gap-2 rounded-full border border-[var(--mustard)]/20 bg-[var(--mustard)]/10 px-4 py-2 text-sm font-medium text-[var(--mustard)]">
      ...
      <section className="relative bg-[var(--warp-indigo)] px-6 py-32">
        ...
        >
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              href="https://github.com/niceBoy0419/openloom/issues/new"
              target="_blank"
              rel="noopener noreferrer"
